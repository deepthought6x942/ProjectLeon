        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="forms.html"> <i class="fa fa-bar-chart-o fa-fw"></i> Projects<span
                    ...
                    @if(Auth::user()->type==="treasurer")
                        <li>
                            <a href='#'><i class="fa fa-table fa-fw"></i> Monetary Donations<span
                                        class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                    ...
                    <li>
                        <a href={{route('eventAttendances.managePortal')}}><i class="fa fa-wrench fa-fw"></i> Manage
                            Event Attendance</a>
                    </li>
                    <li>
