...
@section('content')
    ...
    <div class="col-lg-8">
        ...
        @if($projectsTable!=="N/A")
            <p>Select the Associated Event or Project from the table below. If it is not present, you can create a new
                one {{link_to_route('projects.create','here')}}
            <div class="table-responsive">
        ...
        <p> Select the user from the table below. If they are not present in the database, enter their name and email in
            the boxes below the table and select submit.
